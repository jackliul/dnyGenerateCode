...
public class CodeGenerateFactoryIntelinkOms {
	...
	private static void init() {
		...
		String templateBasePath = System.getProperty("user.dir") + File.separator
				+ NewPropertiesReaderUtil.getConfigInfo("templatePath");
		try {
		...
		hasMapperPath = StringUtils.isNotEmpty(NewPropertiesReaderUtil.generateBundlePath.getString("mapperPath"))
				? true
				: false;
		hasDao = StringUtils.isNotEmpty(NewPropertiesReaderUtil.generateBundlePath.getString("daoPath")) ? true : false;
